...
def get_totalpage(typeparam) :
	bspurl = 'http://d.sungoin.cn/agent/xuanhao.do?param=findXuanHao'+typeparam;
	s = requests.Session();
	s.mount("http://d.sungoin.cn/",HTTPAdapter(
...
def hanle_request(typeparam,pageNo) :
	arr = [];
	bspurl = 'http://d.sungoin.cn/agent/xuanhao.do?param=findXuanHao&type='+typeparam+"&pageNo="+str(pageNo)+"&pageSize=80";
	# bspurl = 'http://d.sungoin.cn/agent/xuanhao.do?param=findXuanHao&type=无规则&pageNo="+str(pageNo)+"&pageSize=80‘;
	print bspurl
	s = requests.Session();
...
arr = [];
types= [];
bspurl = 'http://d.sungoin.cn/agent/xuanhao.do?param=findXuanHao';
