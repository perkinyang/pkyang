...
public class Tel400AddionalAdapter extends BaseAdapter
{
	private List<AdditionalBean> telList;
	private LayoutInflater mInflater;
	private Context mContext;
	public Tel400AddionalAdapter(Context context, List<AdditionalBean> list)
	{
	...
	{      
		...
		final AdditionalBean bean = getItem(position);
