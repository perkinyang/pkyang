...
public class Tel400SelectActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initBack();
		mAdapter = new Tel400SelectAdapter(this,telList,false);
		...
		banner.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent intent=new Intent(Tel400SelectActivity.this,Tel400PromptionSelectActivity.class);
	...
	private synchronized void getTelList(final String type){
		...
		params.addQueryStringParameter("promptionStatus",String.valueOf(PromptionStatusEnum.NOPROMPTION.getCode()));
