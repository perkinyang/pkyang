package com.top.jbb.activity.pay;
...
public class ShoppingCartActivity extends Activity {
    ...
    private int count;   //充值金额
    private String orderNumber; //订单号
    private String title; //支付显示的标题
    private TextView payCount;
    private TextView payOrderNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.count=this.getIntent().getIntExtra("count", 0);
        this.orderNumber=this.getIntent().getStringExtra("orderNumber");
        this.title=this.getIntent().getStringExtra("title");
        payCount=(TextView)this.findViewById(R.id.pay_count);
        payOrderNumber=(TextView)this.findViewById(R.id.pay_order_number);
        payCount.setText(String.valueOf(count));
        payOrderNumber.setText(orderNumber);
        initBack();
        ...
        Integer[] payIcons = new Integer[]{R.drawable.icon_wechat, R.drawable.icon_alipay,R.drawable.icon_unionpay};
        final String[] payNames = new String[]{"微信支付", "支付宝支付","银联在线"};
       
        PayMethodListItem adapter = new PayMethodListItem(this, payIcons, payNames);
...
//count*100,
                    ...
                    case 2: //银联支付
                        ...
                        //支付金额，以分为单位，必须是正整数
                        payParam.billTotalFee = count*100;
                        //商户自定义订单号
                        payParam.billNum =orderNumber;
