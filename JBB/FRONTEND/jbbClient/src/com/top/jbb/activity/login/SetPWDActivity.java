...
public class SetPWDActivity extends Activity implements CallBackInterface{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pwd=(EditText)this.findViewById(R.id.set_pwd_pwd);
		pwd2=(EditText)this.findViewById(R.id.set_pwd_pwd1);
		next=(TextView)this.findViewById(R.id.set_pwd_next);
	...
	private void next(View v){
		...
		String invitationCode=this.getIntent().getStringExtra("invitationCode");
	...
	public void successCallBack(ResponseInfo<String> response,Map<String, Object> map2) {
		...
		if(resp.getResult()<0){
			...
			Intent intent = new Intent(this, FillPersonDetailActivity.class);
