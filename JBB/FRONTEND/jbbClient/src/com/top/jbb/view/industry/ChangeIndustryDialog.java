package com.top.jbb.view.industry;
...
public class ChangeIndustryDialog extends Dialog implements
	...
	public ChangeIndustryDialog(Context context) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.self_dialog_change_industry);
