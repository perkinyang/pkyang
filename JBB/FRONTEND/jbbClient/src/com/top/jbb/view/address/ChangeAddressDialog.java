...
public class ChangeAddressDialog extends Dialog implements android.view.View.OnClickListener,OnWheelChangedListener{
	...
	private TextView btnCancel;//确定按钮
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.self_dialog_change_address);
...
////////////////////////////////////////////////////华丽的分界线	
	...
	public interface OnAddressCListener {
		public void onClick(String province, String city, String area,String areaCode);
	}
	...
	public void onClick(View v) {
		if (v == btnSure) {
			if (onAddressCListener != null) {
				onAddressCListener.onClick(strProvince, strCity,strArea,areaCode);
			}
		}
		dismiss();
	}
