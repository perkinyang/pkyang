...
public class AddAndSubView extends LinearLayout
{
	...
	private void initialise()
	{
		...
		addButton.setTag("+");
		subButton.setTag("-");
		subButton.setBackgroundResource(R.drawable.inputlayout2);
		addButton.setBackgroundResource(R.drawable.inputlayout2);
		editText.setBackgroundResource(R.drawable.inputlayout4);
		//设置输入类型为数字
