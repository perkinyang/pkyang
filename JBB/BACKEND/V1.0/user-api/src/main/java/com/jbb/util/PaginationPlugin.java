...
public class PaginationPlugin extends org.mybatis.generator.api.PluginAdapter {
    @Override
    ...
    public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(XmlElement element,
        ...
        isNotNullElement.addAttribute(new Attribute("test", "limitStart != null and limitStart>=0")); // $NON-NLS-1$ //
                                                                                                      // $NON-NLS-1$ $NON-NLS-2$
